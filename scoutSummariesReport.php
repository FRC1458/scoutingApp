...
if ($result->num_rows > 0) {
	...
	while($row = $result->fetch_assoc()) {
		if($counter == 0 ){
			print "<div id = \"left\" style = \"vertical-align:top; float:left; margin: 20px; width = 100px\"><table><td>";
		}
		else if($counter == 1){
			print "<div id = \"middle\" style = \"vertical-align:top; float:left; margin: 20px; float:left; width = 200px\"><table><td>";
		}else if ($counter == 2){
			print "<div id = \"right\" style = \"vertical-align:top; float:left; margin: 20px; width = 100px\"><table><td>";
