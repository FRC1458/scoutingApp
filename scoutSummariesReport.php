...
if ($result->num_rows > 0) {
	...
	while($row = $result->fetch_assoc()) {
		if($counter == 0 ){
			...
			print "<div id = \"middle\" style = \"vertical-align:top; float:left; margin: 0 auto; float:left; width = 200px\"><table><td>";
		}else if ($counter == 2){
			print "<div id = \"right\" style = \"vertical-align:top; float:left; width = 100px\"><table><td>";
