...
if ($result->num_rows > 0) {
	...
	while($row = $result->fetch_assoc()) {
		if($counter == 0 ){
			print "<div id = \"left\" style = \"vertical-align:top; float:left; margin-top: 0px!important; margin-left!important: border-top:0 px!important; 0px; width = 100px\"><table><td>";
		}
		else if($counter == 1){
			print "<div id = \"middle\" style = \"vertical-align:top; float:left; margin-top: 0px!important; margin-left!important: border-top:0 px!important; 500px; float:left; width = 200px\"><table><td>";
		}else if ($counter == 2){
			print "<div id = \"right\" style = \"vertical-align:top; float:left; margin-top: 0px!important; margin-left!important: border-top:0 px!important; 700px; width = 100px\"><table><td>";
